...
public class @GameInputActions : IInputActionCollection, IDisposable
{
    ...
    ""maps"": [
        {
            ...
            ""actions"": [
                ...
                },
                {
                    ""name"": ""Use"",
                    ""type"": ""Button"",
                    ""id"": ""6e735004-acb6-4506-b775-c04ba58203d6"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": ""NormalizeVector2"",
                    ""interactions"": ""Press""
                }
            ...
            ""bindings"": [
                ...
                {
                    ""name"": """",
                    ""id"": ""57c1d22a-41cf-47a4-8041-8eb887ee1fdd"",
                    ""path"": ""<Keyboard>/e"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": ""Keyboard"",
    ...
    ""controlSchemes"": [
        ...
        m_ThirdPerson_Use = m_ThirdPerson.FindAction("Use", throwIfNotFound: true);
    }
    ...
    private readonly InputAction m_ThirdPerson_Use;
    public struct ThirdPersonActions
    {
        ...
        public InputAction @Use => m_Wrapper.m_ThirdPerson_Use;
        ...
        public void SetCallbacks(IThirdPersonActions instance)
        {
            if (m_Wrapper.m_ThirdPersonActionsCallbackInterface != null)
            {
                ...
                @Use.started -= m_Wrapper.m_ThirdPersonActionsCallbackInterface.OnUse;
                @Use.performed -= m_Wrapper.m_ThirdPersonActionsCallbackInterface.OnUse;
                @Use.canceled -= m_Wrapper.m_ThirdPersonActionsCallbackInterface.OnUse;
            }
